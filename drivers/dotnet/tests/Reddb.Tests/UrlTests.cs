...
public class UrlTests
{
    ...
    [InlineData("reds://reddb.example.com:55555", RedUrl.Kind.RedwireTls, "reddb.example.com", 55555)]
    [InlineData("http://localhost", RedUrl.Kind.Http, "localhost", 5000)]
    [InlineData("http://localhost:5000", RedUrl.Kind.Http, "localhost", 5000)]
    [InlineData("https://reddb.example.com", RedUrl.Kind.Https, "reddb.example.com", 55555)]
    [InlineData("https://reddb.example.com:55555", RedUrl.Kind.Https, "reddb.example.com", 55555)]
