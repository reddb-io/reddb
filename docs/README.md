...
## When to reach for RedDB

| Your situation | RedDB fit | Alternative |
|:---------------|:----------|:------------|
| You're building a RAG app and don't want a vector DB + cache + relational DB stitched together | **Strong** — one engine, [RAG in 20 lines](/guides/rag-in-20-lines.md) | pgvector + Redis + Postgres |
