...
```bash
# Health check
grpcurl -plaintext 127.0.0.1:55055 reddb.v1.RedDb/Health

# List collections
grpcurl -plaintext 127.0.0.1:55055 reddb.v1.RedDb/Collections
```
...
grpcurl -plaintext \
  ...
  127.0.0.1:55055 reddb.v1.RedDb/BulkInsertBinary
```
