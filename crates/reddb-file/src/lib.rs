...
pub use physical_metadata::{
    ...
    PhysicalCatalogCollectionStats, PhysicalCatalogSnapshot, PhysicalGraphProjection,
    PhysicalMetadataDocumentEnvelope, PhysicalPageLocation, PhysicalSchemaManifest,
    PhysicalSchemaOptions, PhysicalSubscriptionDescriptor, PhysicalTreeDefinition,
