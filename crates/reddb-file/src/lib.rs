...
pub use physical_metadata::{
    ...
    decode_physical_analytics_job_json, decode_physical_block_reference_json,
    decode_physical_catalog_snapshot_json, decode_physical_export_descriptor_json,
    ...
    encode_physical_catalog_snapshot_json, encode_physical_export_descriptor_json,
    ...
    PhysicalAnalyticalStorageConfig, PhysicalAnalyticsJob, PhysicalCatalogCollectionStats,
    PhysicalCatalogSnapshot, PhysicalGraphProjection, PhysicalMetadataDocumentEnvelope,
    PhysicalPageLocation, PhysicalSchemaManifest, PhysicalSchemaOptions,
    PhysicalSubscriptionDescriptor, PhysicalTreeDefinition, SnapshotDescriptor, SuperblockHeader,
