...
pub use native_store::{
    ...
    verify_native_store_crc32_footer, NativeCatalogCollectionSummary, NativeCatalogSummary,
    NativeDumpCollectionHeader, NativeDumpCrossRef, NativeEntityRecordFrame, NativeExportSummary,
    NativeManifestEntrySummary, NativeManifestSummary, NativeMetadataOverflowContinuationHeader,
    NativeMetadataOverflowHeader, NativeMetadataStateSummary, NativePagedCollectionRoot,
    NativePagedCrossRef, NativePagedMetadataHeader, NativeRecoverySummary,
    ...
    NativeVectorArtifactSummary, ENTITY_RECORD_MAGIC, METADATA_HEADER_BYTES, METADATA_MAGIC,
...
pub use physical_metadata::{
    copy_physical_metadata_binary_to_journal, decode_persisted_physical_hypertable_chunk_json,
    decode_persisted_physical_hypertable_json, decode_persisted_physical_index_state_json,
    decode_physical_analytical_storage_json, decode_physical_analytics_job_json,
    decode_physical_analytics_view_descriptor_json, decode_physical_block_reference_json,
    decode_physical_catalog_snapshot_json, decode_physical_collection_contract_json,
    decode_physical_declared_column_contract_json, decode_physical_export_descriptor_json,
    decode_physical_graph_projection_json, decode_physical_manifest_event_json,
    decode_physical_manifest_pointers_json, decode_physical_metadata_document,
    decode_physical_metadata_document_root_json, decode_physical_schema_manifest_json,
    decode_physical_snapshot_descriptor_json, decode_physical_subscription_descriptor_json,
    decode_physical_superblock_json, decode_physical_tree_definition_json,
    encode_persisted_physical_hypertable_chunk_json, encode_persisted_physical_hypertable_json,
    encode_persisted_physical_index_state_json, encode_physical_analytical_storage_json,
    encode_physical_analytics_job_json, encode_physical_analytics_view_descriptor_json,
    encode_physical_block_reference_json, encode_physical_catalog_snapshot_json,
    encode_physical_collection_contract_json, encode_physical_declared_column_contract_json,
    encode_physical_export_descriptor_json, encode_physical_graph_projection_json,
    encode_physical_manifest_event_json, encode_physical_manifest_pointers_json,
    encode_physical_metadata_binary_document, encode_physical_metadata_document_root_json,
    encode_physical_metadata_json_document, encode_physical_schema_manifest_json,
    encode_physical_snapshot_descriptor_json, encode_physical_subscription_descriptor_json,
    encode_physical_superblock_json, encode_physical_tree_definition_json,
    list_physical_metadata_journal_paths, prune_physical_metadata_journal_paths,
    read_physical_metadata_document, write_physical_metadata_binary_document,
    write_physical_metadata_json_document, BlockReference, ExportDescriptor, ManifestEvent,
    ManifestEventKind, ManifestPointers, PersistedPhysicalHypertable,
    PersistedPhysicalHypertableChunk, PersistedPhysicalIndexState, PhysicalAnalyticalStorageConfig,
    PhysicalAnalyticsJob, PhysicalAnalyticsViewDescriptor, PhysicalCatalogCollectionStats,
    PhysicalCatalogSnapshot, PhysicalCollectionContract, PhysicalDeclaredColumnContract,
    PhysicalGraphProjection, PhysicalMetadataDocumentEnvelope, PhysicalPageLocation,
    PhysicalSchemaManifest, PhysicalSchemaOptions, PhysicalSqlTypeName,
