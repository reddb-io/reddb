...
pub use physical_metadata::{
    ...
    PhysicalAnalyticsJob, PhysicalCatalogCollectionStats, PhysicalCatalogSnapshot,
    PhysicalGraphProjection, PhysicalMetadataDocumentEnvelope, PhysicalPageLocation,
    PhysicalSchemaManifest, PhysicalSchemaOptions, PhysicalTreeDefinition, SnapshotDescriptor,
    SuperblockHeader, DEFAULT_PHYSICAL_FORMAT_VERSION, DEFAULT_SUPERBLOCK_COPIES,
