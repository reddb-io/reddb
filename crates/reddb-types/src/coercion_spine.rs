...
use crate::cast_catalog::{find_cast, CastContext, CastEntry};
use crate::function_catalog::{FunctionEntry, FUNCTION_CATALOG};
use crate::operator::BinOp;
use crate::operator_catalog::{OperatorEntry, OperatorKind, OPERATOR_CATALOG};
...
impl CoercionSpine for BuiltinSpine {
    fn resolve_cast(&self, from: DataType, to: DataType) -> Option<&'static CastEntry> {
        ...
        crate::cast_catalog::CAST_CATALOG
            .iter()
