...
fn table_def_json(table_def: &reddb_types::TableDef) -> JsonValue {
    let mut object = Map::new();
    object.insert(
        "name".to_string(),
...
fn schema_data_type_str(data_type: reddb_types::DataType) -> &'static str {
    match data_type {
        reddb_types::DataType::Integer => "integer",
        reddb_types::DataType::UnsignedInteger => "unsigned_integer",
        reddb_types::DataType::Float => "float",
        reddb_types::DataType::Text => "text",
        reddb_types::DataType::Blob => "blob",
        reddb_types::DataType::Boolean => "boolean",
        reddb_types::DataType::Timestamp => "timestamp",
        reddb_types::DataType::Duration => "duration",
        reddb_types::DataType::IpAddr => "ipaddr",
        reddb_types::DataType::MacAddr => "macaddr",
        reddb_types::DataType::Vector => "vector",
        reddb_types::DataType::Nullable => "nullable",
        reddb_types::DataType::Unknown => "unknown",
        reddb_types::DataType::Json => "json",
        reddb_types::DataType::Uuid => "uuid",
        reddb_types::DataType::NodeRef => "noderef",
        reddb_types::DataType::EdgeRef => "edgeref",
        reddb_types::DataType::VectorRef => "vectorref",
        reddb_types::DataType::RowRef => "rowref",
        reddb_types::DataType::Color => "color",
        reddb_types::DataType::Email => "email",
        reddb_types::DataType::Url => "url",
        reddb_types::DataType::Phone => "phone",
        reddb_types::DataType::Semver => "semver",
        reddb_types::DataType::Cidr => "cidr",
        reddb_types::DataType::Date => "date",
        reddb_types::DataType::Time => "time",
        reddb_types::DataType::Decimal => "decimal",
        reddb_types::DataType::DecimalText => "decimal_text",
        reddb_types::DataType::Enum => "enum",
        reddb_types::DataType::Array => "array",
        reddb_types::DataType::TimestampMs => "timestamp_ms",
        reddb_types::DataType::Ipv4 => "ipv4",
        reddb_types::DataType::Ipv6 => "ipv6",
        reddb_types::DataType::Subnet => "subnet",
        reddb_types::DataType::Port => "port",
        reddb_types::DataType::Latitude => "latitude",
        reddb_types::DataType::Longitude => "longitude",
        reddb_types::DataType::GeoPoint => "geopoint",
        reddb_types::DataType::Country2 => "country2",
        reddb_types::DataType::Country3 => "country3",
        reddb_types::DataType::Lang2 => "lang2",
        reddb_types::DataType::Lang5 => "lang5",
        reddb_types::DataType::Currency => "currency",
        reddb_types::DataType::AssetCode => "asset_code",
        reddb_types::DataType::Money => "money",
        reddb_types::DataType::ColorAlpha => "color_alpha",
        reddb_types::DataType::BigInt => "bigint",
        reddb_types::DataType::KeyRef => "keyref",
        reddb_types::DataType::DocRef => "docref",
        reddb_types::DataType::TableRef => "tableref",
        reddb_types::DataType::PageRef => "pageref",
        reddb_types::DataType::Secret => "secret",
        reddb_types::DataType::Password => "password",
        reddb_types::DataType::TextZstd => "text",
        reddb_types::DataType::BlobZstd => "blob",
    }
}
