...
pub use placement::{
    ...
    HotspotRange, MemberCapacity, MoveReason, PlacementPolicy, PlacementSignals, PlacementWarning,
    PlannedMove, PlannedReplicaReplacement, RangeLoad, RebalancePlan, WeightedPlacementPlanner,
