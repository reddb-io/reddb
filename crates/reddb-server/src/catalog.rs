...
// Catalog AST-leaf descriptors re-homed to the neutral keystone crate (ADR
// 0053, RQL Phase 2 S4b) so the canonical SQL AST
// (`CreateTableQuery.{subscriptions, analytics_config}`) resolves them without a
