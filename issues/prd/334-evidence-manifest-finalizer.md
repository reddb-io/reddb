...
- [ ] The evidence report has explicit final-disposition fields for confirmed, superseded, reopened, and split outcomes.
- [ ] Every issue currently marked code_evidence_partial or code_evidence_confirmed_github_open has a machine-readable placeholder disposition before domain slices refine it.
- [ ] The report generator can be rerun from the repo root and produces valid JSON with 311 unique issue entries.
- [ ] The parent PRD #333 remains open and unchanged except for child issue references if maintainers choose to add them later.
